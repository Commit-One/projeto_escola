...
import { ScheduleTypeOrmRepository } from "../infrastructure/database/repositories/schedule.repository";
...
container.registerSingleton(
  ContainerEnum.SCHEDULE_REPOSITORY,
  ScheduleTypeOrmRepository,
);
